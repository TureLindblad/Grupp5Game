...
namespace Grupp5Game
{
    ...
    public class Tower
    {
        ...
        public virtual void Fire(Vector2 targetPosition, List<MagicProjectile> magicProjectiles, Texture2D magicProjectileTexture) // L�gg till en virtuell metod f�r magiprojektiler
        {
        }
